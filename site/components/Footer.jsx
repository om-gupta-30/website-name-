...
function Footer({ footerData: propFooterData }) {
  ...
  return (
    <footer id="footer" className="ft">
      ...
      <div className="ft-gold-strip"></div>
      ...
      <div className="ft-content">
        ...
        <div id="contact" className="ft-col">
          ...
          <div className="ft-contact">
            {email && (
              <a href={`mailto:${email}`} className="ft-email-button">
            ...
            {phone && (() => {
              const numbers = phone.split(/\s*\/\s*/).map((n) => n.trim());
              return (
                <div className="ft-contact-phone">
                  {numbers.map((num, i) => (
                    <div key={i} className="ft-contact-phone-row ft-contact-item">
                      <span className="ft-contact-phone-label">{i === 0 ? "Phone: " : ""}</span>
                      <span>{num}</span>
                    </div>
                  ))}
                </div>
