      ...
      <div className="ft-content">
        ...
        <div id="contact" className="ft-col">
          ...
          <div className="ft-contact">
            {phone && (
              <div className="ft-contact-item-wrapper">
                <p className="ft-contact-item">Phone: {phone}</p>
                <a href={`tel:${phone.replace(/\s/g, '').split('/')[0]}`} className="ft-call-button">
            ...
            {email && <p className="ft-contact-item">Email: {email}</p>}
